...
// impl Webhook {
    // NOTE not required as the mapping is now username -> slackId instead of anon-email -> email -> slackId
    ...
    // NOTE moved to slack::message::MySlackMessage
    ...
    // NOTE:  Moved to gitea::webhook::Comment
    ...
    // NOTE: moved to slack::user
    // #[instrument(err)]
    // pub async fn fetch_slack_user_from_email(email: &str) -> Result<SlackUser, anyhow::Error> {
...
// NOTE moved to multiple locations
